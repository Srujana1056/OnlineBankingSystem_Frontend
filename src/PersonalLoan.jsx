...
export default function PersonalLoan() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Personal Loan application submitted successfully! We will contact you within 24 hours.');
  ...
  return (
    <div className="loan-application-page">
      <div className="loan-header">
        ...
        <p>Complete your personal loan application with all required documents</p>
      </div>
