...
export default function HomeLoan() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Home Loan application submitted successfully! We will contact you within 24 hours.');
  ...
  return (
    <div className="loan-application-page">
      <div className="loan-header">
        ...
        <p>Complete your home loan application with all required documents</p>
      </div>
